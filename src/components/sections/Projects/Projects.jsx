...
import mbFisioterapeutaThumb from '../../../assets/mbb-thumb.png'
import ClayTechThumb from '../../../assets/ClayTechThumb.png'
...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      title: 'ClayTech',
      description:
        'Website profissional responsivo para serviços de informática, desenvolvido para cliente real com foco em presença digital, performance e experiência do usuário..',
      technologies: ['React JS', 'Mobile-first', 'TailwindCSS'],
      features: ['Layout Responsivo', 'Portfólio', 'Assistência Técnica'],
      liveUrl: 'https://claytech.vercel.app/',
      codeUrl: 'https://github.com/gufvr/ClayTech',
      thumbnail: ClayTechThumb,
      featured: false,
    },
  ]
    ...
    <section id='projetos' className='projects'>
      ...
      <div className='projects-container'>
        <div className='projects-header'>
          ...
          <p className='projects-subtitle'>Soluções inovadoras que demonstram expertise técnica e visão estratégica</p>
        </div>
              ...
              <div className='project-content'>
                ...
                <div className='project-links'>
                  <a href={project.liveUrl} target='_blank' rel='noopener noreferrer' className='project-btn-primary'>
                    {project.id === 3 ? 'Ver Site' : project.id === 2 ? 'Ver Site' : 'Ver Site'}
                  </a>
                  <a href={project.codeUrl} target='_blank' rel='noopener noreferrer' className='project-btn-secondary'>
                    Código
                  </a>
                </div>
              </div>
        ...
        <div className='projects-cta'>
          <a href='https://github.com/gufvr?tab=repositories' target='_blank' rel='noopener noreferrer' className='projects-btn-more'>
