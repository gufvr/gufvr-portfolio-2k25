        ...
        <div className='hero-content'>
          <div className={`hero-text ${isVisible ? 'hero-text-visible' : ''}`}>
            ...
            <p className='hero-description'>
              Transformo ideias em soluções digitais com foco em performance e experiência do usuário, utilizando tecnologias como{' '}
              <strong className='tech-js'>JavaScript</strong>, <strong className='tech-ts'>TypeScript</strong>,
              <strong className='tech-react'> React</strong>, <strong className='tech-node'>Node.js</strong> e{' '}
              <strong className='tech-rn'>React Native</strong>.
            </p>
            ...
            <div className='hero-buttons'>
              ...
              <a
                href='https://www.linkedin.com/messaging/compose/?recipient=gufvr'
                target='_blank'
          ...
          <div className={`hero-image ${isVisible ? 'hero-image-visible' : ''}`}>
            <div className='hero-profile'>
              <div className='profile-glow'>
                <img src='/Hero.jpg' alt='Gustavo Favero' className='profile-image' />
