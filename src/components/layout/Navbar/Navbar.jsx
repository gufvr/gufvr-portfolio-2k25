    ...
    <nav className='navbar'>
      <div className='navbar-container'>
        <div className='navbar-content'>
          ...
          <ul className='navbar-menu'>
            ...
            <li>
              <a href='https://www.linkedin.com/in/gufvr' target='_blank' rel='noopener noreferrer' className='navbar-link group'>
                <span className='navbar-link-text'>LinkedIn</span>
                <span className='navbar-link-underline'></span>
              </a>
            </li>
            <li>
              <a href='https://www.instagram.com/faveroid' target='_blank' rel='noopener noreferrer' className='navbar-link group'>
                <span className='navbar-link-text'>Instagram</span>
                <span className='navbar-link-underline'></span>
              </a>
            </li>
            <li>
              <a href='https://dev.to/gufvr' target='_blank' rel='noopener noreferrer' className='navbar-link group'>
      ...
      <div className={`navbar-mobile ${isOpen ? 'navbar-mobile-open' : ''}`}>
        <ul className='navbar-mobile-menu'>
          ...
          <li>
            <a href='https://www.instagram.com/faveroid' target='_blank' rel='noopener noreferrer' className='navbar-mobile-link'>
              Instagram
            </a>
          </li>
          <li>
            <a href='https://dev.to/gufvr' target='_blank' rel='noopener noreferrer' className='navbar-mobile-link'>
              DEV Community
            </a>
          </li>
        </ul>
